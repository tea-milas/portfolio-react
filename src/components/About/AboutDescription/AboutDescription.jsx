    ...
    <article className={styles.about__description}>
      <section className={styles.text_and_link}>
        <h4 className={styles.about__text}>
          hi, i'm <span>tea milas</span>. <br /> i'm a software developer based
          in london.
        </h4>
        <ul className={styles.contact__links}>
          <li>
            <a
              href="https://github.com/tea-milas"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/tea-milas/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a href="mailto: teamilas@hotmail.com">
              <FontAwesomeIcon icon={["fas", "envelope"]} />
            </a>
          </li>
          <li>
            <a
              href="https://drive.google.com/file/d/1UDO8lQxqL9D1MsgzKWbkvZau61U2q9Rk/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              <FontAwesomeIcon
